  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Wallet,
      permission: PERMISSIONS.PAYMENT_VOUCHERS_READ,
      },
      {
        title: "Receipt Vouchers",
        url: "/finance/vouchers/receipt",
        icon: Banknote,
        permission: PERMISSIONS.RECEIPT_VOUCHERS_READ,
      },
      {
        title: "Journal Vouchers",
        url: "/finance/vouchers/journal",
        icon: NotebookPen,
        permission: PERMISSIONS.JOURNAL_VOUCHERS_READ,
      },
      {
        title: "Balance Transfer",
        url: "/finance/balance-transfer",
        icon: ArrowLeftRight,
        permission: PERMISSIONS.BALANCE_TRANSFERS_READ,
      },
      {
