  ...
  const payments = [
    {
      ...
      status: "completed",
      description: "Partial payment for electronic compone"
    },
    {
      id: "PAY-2024-002",
    ...
    },
    {
      ...
      reference: "CC-456789",
      status: "completed",
      description: "Initial payment for compone"
    },
    {
      id: "PAY-2024-005",
      ...
      status: "failed",
      description: "Payment attempt for premium pa"
    }
  ]
                  ...
                  <TableRow key={payment.id} className="hover:bg-accent/50">
                    ...
                    <TableCell>
                      <Button 
                        ...
                        onClick={() => router.push(`/view-invoice/${payment.invoiceId}`)}
                      >
                        {payment.invoiceId}
                      </Button>
                    </TableCell>
