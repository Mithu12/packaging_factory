                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox 
                        ...
                        onCheckedChange={(checked) => handleInputChange("includePayme", checked as boolean)}
                      />
                      <Label htmlFor="includePayme">Payments</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox 
                        id="includeCred"
                        checked={formData.includeCredits}
                        onCheckedChange={(checked) => handleInputChange("includeCred", checked as boolean)}
                      />
                      <Label htmlFor="includeCred">Credit Notes</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox 
                        id="includeAging"
