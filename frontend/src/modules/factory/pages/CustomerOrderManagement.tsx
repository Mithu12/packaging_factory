    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="all-orders" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="quoted-orders">Quoted</TabsTrigger>
        ...
        <TabsContent value="quoted-orders" className="space-y-4">
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                {orders
                  .filter((order) => order.status === "quoted")
                  .map((order) => (
                    <Card key={order.id}>
                      <CardContent className="pt-6">
                        <div className="flex items-center justify-between mb-4">
                      ...
                      <CardContent className="pt-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {formatDate(
                                order.approvedDate || order.updatedDate || ""
                              )}
                            </p>
                          </div>
                          <div>
