...
} from "@/modules/hrm/data/attendance-data";
import { mockShifts, getShiftOptions } from "@/modules/hrm/data/shift-data";
import { mockEmployees } from "@/modules/hrm/data/salary-update-data";
import { mockDepartments } from "@/modules/hrm/data/salary-update-data";
import {
  AttendanceRecord,
  Employee,
  Department,
