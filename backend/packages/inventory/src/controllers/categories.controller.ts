...
class CategoriesController {
  ...
  async updateCategory(
    ...
    try {
      ...
      const category = await UpdateCategoryInfoMediator.updateCategory(
        id,
        req.body
      );
      MyLogger.success(action, { categoryId: id, categoryName: category.name });
  ...
  async getAllSubcategories(
    ...
    try {
      MyLogger.info(action, { query: req.query });
      const result = await GetCategoryInfoMediator.getSubcategoryList(
        req.query
      );
      MyLogger.success(action, {
        total: result.total,
  ...
  async searchSubcategories(
    ...
    try {
      ...
      MyLogger.success(action, {
        query: q,
        resultsCount: subcategories.length,
      });
  ...
  async updateSubcategory(
    ...
    try {
      ...
      const subcategory = await UpdateCategoryInfoMediator.updateSubcategory(
        id,
        req.body
      );
      MyLogger.success(action, {
