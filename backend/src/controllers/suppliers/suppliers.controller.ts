...
class SuppliersController {
    ...
    async getSupplierCategories(req: Request, res: Response, next: NextFunction): Promise<void> {
        const categories = await GetSuppliersMediator.getSupplierCategories();
        serializeSuccessResponse(res, categories, 'SUCCESS');
    }

    async searchSuppliers(req: Request, res: Response, next: NextFunction): Promise<void> {
