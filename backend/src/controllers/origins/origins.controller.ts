...
class OriginsController {
    async getAllOrigins(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    async getOriginById(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    async createOrigin(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    async updateOrigin(req: Request, res: Response, next: NextFunction): Promise<void> {
        ...
        try {
            ...
            MyLogger.error(action, error, { origin_id: req.params.id, updates: req.body });
            throw error;
        }
    }

    async deleteOrigin(req: Request, res: Response, next: NextFunction): Promise<void> {
