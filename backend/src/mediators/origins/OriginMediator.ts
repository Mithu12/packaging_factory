...
import { Origin, CreateOriginRequest, UpdateOriginRequest, OriginWithProductCount } from '@/types/origin';
...
export class OriginMediator {
  ...
  // Update origin
  static async updateOrigin(id: number, updateData: UpdateOriginRequest): Promise<Origin> {
  ...
  static async getOriginsByStatus(status: 'active' | 'inactive'): Promise<OriginWithProductCount[]> {
