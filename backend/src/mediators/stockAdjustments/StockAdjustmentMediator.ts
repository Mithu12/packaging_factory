...
export class StockAdjustmentMediator {
  ...
  static async getStockAdjustments(params: StockAdjustmentQueryParams): Promise<StockAdjustment[]> {
  ...
  static async getStockAdjustmentStats(productId?: number): Promise<StockAdjustmentStats> {
    ...
    try {
      ...
      const stats = {
        ...
        total_quantity_adjusted: parseFloat(statsResult.rows[0].total_quantity_adjusted) || 0,
