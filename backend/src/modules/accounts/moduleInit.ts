...
export const initializeAccountsModule = (): void => {
  try {
    ...
    interModuleConnector.register('accModule', {
      ...
      addPurchaseReturnVoucher: inventoryAccountsIntegrationService.createPurchaseReturnVoucher.bind(inventoryAccountsIntegrationService),
      ...
      addDeliveryReturnVoucher: factoryAccountsIntegrationService.createDeliveryReturnVouchers.bind(factoryAccountsIntegrationService),
