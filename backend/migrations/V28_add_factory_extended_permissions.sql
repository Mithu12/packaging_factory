...
INSERT INTO permissions (name, description, category) VALUES
('FACTORY_CONSUMPTIONS_READ', 'View material consumptions', 'Factory Operations'),
('FACTORY_CONSUMPTIONS_CREATE', 'Record material consumptions', 'Factory Operations')
ON CONFLICT (name) DO NOTHING;

-- Wastage Permissions
INSERT INTO permissions (name, description, category) VALUES
('FACTORY_WASTAGE_READ', 'View wastage records', 'Factory Operations'),
('FACTORY_WASTAGE_APPROVE', 'Approve wastage records', 'Factory Operations'),
('FACTORY_WASTAGE_REJECT', 'Reject wastage records', 'Factory Operations')
ON CONFLICT (name) DO NOTHING;
...
AND p.name IN (
    ...
    'FACTORY_CONSUMPTIONS_READ',
    'FACTORY_CONSUMPTIONS_CREATE',
    'FACTORY_WASTAGE_READ',
    'FACTORY_WASTAGE_APPROVE',
    'FACTORY_WASTAGE_REJECT',
