  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        url: "/factory/orders",
        icon: Package,
        permission: PERMISSIONS.FACTORY_ORDERS_APPROVE,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        url: "/accounts/vouchers/payment",
        icon: Wallet,
        permission: PERMISSIONS.VOUCHERS_READ,
      },
      {
        title: "Receipt Vouchers",
        url: "/accounts/vouchers/receipt",
        icon: Banknote,
        permission: PERMISSIONS.VOUCHERS_READ,
      },
      {
        title: "Journal Vouchers",
        url: "/accounts/vouchers/journal",
        icon: NotebookPen,
        permission: PERMISSIONS.VOUCHERS_READ,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: FileText,
        permission: PERMISSIONS.HR_ATTENDANCE_UPDATE,
      },
      {
